...
# LAYER ZERO DOES NOT WORK ON ROPSTEN!!
 forge create ./src/Wavect.sol:Wavect --constructor-args $RINKEBY_L0_ENDPOINT "https://wavect.io/official-nft/contract-metadata.json" \
  ...
  --rpc-url $ROPSTEN_RPC_URL  --private-key $PRIVATE_KEY --verify --etherscan-api-key $ETHERSCAN_KEY

echo "DEPLOYED CONTRACT 0 - ROPSTEN (LAYER ZERO NOT SUPPORTED)"
...
#      "https://wavect.io/official-nft/metadata/1.json?debug=" "Wavect" "WACT" ".json" 0 \
